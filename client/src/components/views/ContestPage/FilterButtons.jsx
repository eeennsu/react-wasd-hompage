        ...
        <div> 
          ...
          <button className={'progress_btn' + (progress_Click[0]? " active" : "")} onClick={() => {
           ...
           set_progress_Click(copy)
            ...
            {
            axios.get('board/allPagination/All/1/12')
            .then((response) => { props.set_datas(response.data); })
            }
            else if (category_Click[1] == true)
            {
            axios.get('board/allPagination/Web/1/12')
            .then((response) => { props.set_datas(response.data); })
            }
            else if (category_Click[2] == true)
            {
            axios.get('board/allPagination/App/1/12')
            .then((response) => { props.set_datas(response.data); })
            }
            else if (category_Click[3] == true)
            {
            axios.get('board/allPagination/Idea/1/12')
            .then((response) => { props.set_datas(response.data); })
            }
            }}> 전체보기 </button>
          ...
          <button className={'progress_btn' + (progress_Click[1]? " active" : "")} onClick={() => { 
           ...
           if(category_Click[0] == true)
           {
           axios.get('board/ingPagination/All/1/12')
           .then((response) => { props.set_datas(response.data); })
           }
           else if (category_Click[1] == true)
           {
           axios.get('board/ingPagination/Web/1/12')
           .then((response) => { props.set_datas(response.data); })
           }
           else if (category_Click[2] == true)
           {
           axios.get('board/ingPagination/App/1/12')
           .then((response) => { props.set_datas(response.data); })
           }
           else if (category_Click[3] == true)
           {
           axios.get('board/ingPagination/Idea/1/12')
           .then((response) => { props.set_datas(response.data); })
           }
            }}> 진행중 </button>
          ...
          <button className={'progress_btn' + (progress_Click[2]? " active" : "")} onClick={() => { 
            ...
            if(category_Click[0] == true)
            {
            axios.get('board/endPagination/All/1/12')
            .then((response) => { props.set_datas(response.data); })
            }
            else if (category_Click[1] == true)
            {
            axios.get('board/endPagination/Web/1/12')
            .then((response) => { props.set_datas(response.data); })
            }
            else if (category_Click[2] == true)
            {
            axios.get('board/endPagination/App/1/12')
            .then((response) => { props.set_datas(response.data); })
            }
            else if (category_Click[3] == true)
            {
            axios.get('board/endPagination/Idea/1/12')
            .then((response) => { props.set_datas(response.data); })
            }}}> 진행종료 </button>
           </div>
           <hr className='btn_hr'/>
